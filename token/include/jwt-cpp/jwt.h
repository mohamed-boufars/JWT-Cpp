...
#endif
#include "C:\Users\pc\Desktop\c++token\token\include\picojson\picojson.h"
#endif
...
#include <C:\Program Files\OpenSSL\include\openssl\ec.h>
#include <C:\Program Files\OpenSSL\include\openssl\ecdsa.h>
#include <C:\Program Files\OpenSSL\include\openssl\err.h>
#include <C:\Program Files\OpenSSL\include\openssl\evp.h>
#include <C:\Program Files\OpenSSL\include\openssl\hmac.h>
#include <C:\Program Files\OpenSSL\include\openssl\pem.h>
#include <C:\Program Files\OpenSSL\include\openssl\rsa.h>
#include <C:\Program Files\OpenSSL\include\openssl\ssl.h>
...
#include <C:\Program Files\OpenSSL\include\openssl\param_build.h>
...
// C++11 requires the body of a constexpr constructor to be empty
		...
		inline std::unique_ptr<BIGNUM, decltype(&BN_free)> raw2bn(const std::string& raw, std::error_code& ec) {
			...
			// https://www.C:\Program Files\OpenSSL\include\openssl\org/docs/man1.1.1/man3/BN_bin2bn.html#RETURN-VALUES
			if (!bn) {
		...
		*/
		...
		std::string create_public_key_from_rsa_components(const std::string& modulus, const std::string& exponent,
			...
			// https://mta.C:\Program Files\OpenSSL\include\openssl\org/pipermail/C:\Program Files\OpenSSL\include\openssl\users/2021-July/013994.html
			// https://www.C:\Program Files\OpenSSL\include\openssl\org/docs/man3.1/man3/OSSL_PARAM_BLD_new.html#Example-2
			...
			// https://www.C:\Program Files\OpenSSL\include\openssl\org/docs/man3.0/man3/EVP_PKEY_fromdata.html#EXAMPLES
			// Error codes based on https://www.C:\Program Files\OpenSSL\include\openssl\org/docs/manmaster/man3/EVP_PKEY_fromdata_init.html#RETURN-VALUES
			EVP_PKEY* pkey = NULL;
			if (EVP_PKEY_fromdata_init(ctx.get()) <= 0 ||
				...
				// https://www.C:\Program Files\OpenSSL\include\openssl\org/docs/man3.0/man3/EVP_PKEY_fromdata.html
				EVP_PKEY_free(pkey);
			...
			if (RSA_set0_key(rsa.get(), n.get(), e.get(), nullptr) == 1) {
				...
				// https://github.com/C:\Program Files\OpenSSL\include\openssl\C:\Program Files\OpenSSL\include\openssl\blob/d6e4056805f54bb1a0ef41fa3a6a35b70c94edba/crypto/rsa/rsa_lib.c#L396
...
#if defined(JWT_OPENSSL_3_0)
				// https://www.C:\Program Files\OpenSSL\include\openssl\org/docs/man3.1/man3/PEM_write_bio_RSA_PUBKEY.html
	...
	namespace algorithm {
		 ...
		 *
		 * The EdDSA algorithms were introduced in [OpenSSL v1.1.1](https://www.C:\Program Files\OpenSSL\include\openssl\org/news/C:\Program Files\OpenSSL\include\openssl\1.1.1-notes.html),
